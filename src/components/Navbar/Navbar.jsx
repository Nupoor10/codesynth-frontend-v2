...
const Navbar = ({ toggleDropdown, isOpen, dropdownRef, handleLogout }) => {
  ...
  return (
    <div className="home__navbar">
      <div className="home__navbar__left">
        <div className="home__logo" onClick={() => navigate("/home")}>
        ...
        <div className="home__navbar__links">
          ...
          <button
            className={`nav__link ${
              location.pathname === "/mycodes" ? "active" : ""
            }`}
          ...
          <button
            className={`nav__link ${
              location.pathname.startsWith("/collab") ? "active" : ""
            }`}
      ...
      <div className="home__navbar__right">
        <div className="dashboard__header__icons__container">
          ...
          >
            <FaUserCircle className="dashboard__header__icons" />

            <span className="navbar__username">{user?.name || "Guest"}</span>
          </button>
