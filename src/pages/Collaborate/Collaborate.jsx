    ...
    <div className="userrooms__page__wrapper">
      <div className="userrooms__content__wrapper">
        ...
        <div className="userrooms__hero">
          <span className="userrooms__badge">Real-Time Collaboration</span>

          <h2>Build Together In Shared Rooms</h2>

          <p>
            Create collaborative coding spaces, invite developers, and work
            together in real-time seamlessly.
          </p>
        </div>
        ...
        <div className="collab__actions__grid">
          <div className="collab__action__card">
            ...
            <button onClick={openCreateModal} className="create__room__btn">
              Create Room
            </button>
          </div>
          ...
          <div className="collab__action__card">
            ...
            <form className="join__room__form" onSubmit={handleAddRoom}>
              ...
              <button type="submit" className="join__room__btn">
                Join Room
              </button>
            </form>
          </div>
